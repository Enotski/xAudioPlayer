	...
	public class SettingsRepository {
		...
		private SettingsRepository() {
			ThemesList.AddRange(new List<ThemeItem> {
				...
				new ThemeItem{ Name = "DarkTheme", Colors = new Color[5] {Color.FromHex("#4d5e80"), Color.FromHex("#262f40"), Color.FromHex("#738ebf"), Color.FromHex("#1e2532"), Color.FromHex("#5c8fed") } },
				new ThemeItem{ Name = "AestheticTheme", Colors = new Color[5] {Color.FromHex("#263f73"), Color.FromHex("#5679A6"), Color.FromHex("#D97398"), Color.FromHex("#2d63a8"), Color.FromHex("#222059") } },
